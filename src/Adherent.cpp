...
//Permet d'entrer les donnees personnelles de l'adherent + nom compte associe
...
//Fait l'affichage des donnees personnelles de l'adherent + nom compte associe et solde
...
//Permet d'acceder a l'attribut numero de compte en dehors de la classe mere et classes qui heritent 
...
//Permet d'acceder a l'attribut type de compte en dehors de la classe mere et classes qui heritent 
string Adherent::get_type_compte()
{
    return(this->type_compte);
}

//Operateur qui nous permet d'écrire dans un fichier .xls
...
//Permet d'acceder a l'attribut adresse postale en dehors de la classe mere et classes qui heritent 
...
//Permet d'acceder a l'attribut nom et prenom en dehors de la classe mere et classes qui heritent 
...
//Permet de modifier l'adresse postale d'un adherent deja inscrit 
void Adherent::Modifier_Adresse_Adh()
{
    cout<< "saisir la nouvelle adresse de cet adherent mr/mme "<< this->get_Nom_et_prenom()<<" : "; getchar();
    this->adresse_postale="";
    getline(cin,this->adresse_postale);

    cout<< "La nouvelle adresse de cet adherent mr/mme "<< this->get_Nom_et_prenom()<<" : "<< this->adresse_postale<<endl;

        
}
void Adherent::modifier_Solde(double somme)
{
    this->solde+=somme;
}