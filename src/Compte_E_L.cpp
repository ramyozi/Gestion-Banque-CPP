...
---> En commentaire car fonctions traitees dans Compte.cpp
...
//Permet de voir a quelle date le compte se cloture automatiquement 
...
//Permet de voir a quelle date les fonds seront accessibles
