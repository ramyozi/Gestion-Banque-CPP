...
/*void Compte_livre_A::Ajouter_argent()
 {
---> En commentaire car fonction traitée dans Compte.cpp et Banque.cpp

 }*/

//Affiche un message qui indique que le decouvert n'est pas autorise sur ce compte + le solde acteul
...
/*Permet de retirer de l'argent uniquement si solde sup à 0
Indique le montant du retrait effectue + solde actuel */
void Compte_livre_A::Retirer_Argent(double retrait)
{
    cout << "Votre solde avant l'operation est de" << this->solde << " euros\n";
    if (solde-retrait<0) 
    {
        cout<< "Retrait Impossible !! \n";
    }else{
        this->solde-=retrait;
        //chaque retrait est mis en dernière place du tableau avec le pushback
...
--->En commentaire car fonction traitée dans Compte.cpp
}*/
...
//Fait l'affichage du numero compte, le solde et le type de compte
